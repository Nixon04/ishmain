            ...
            r =
                (e.length &&
                    ((l = e.DataTable({
                        ...
                        ajax:{
                            url: "/ishumanity/dashboard/release_partners",
                            method: 'GET',
                            dataType: 'json',
                            dataSrc: 'data',
                          },
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                searchable: !1,
                                render: function (e, t, a, s) {
                                    var email = a.email_address;
                                    console.log(email);
                                    return '<div class="d-inline-block"><a href="javascript:void(0)" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></a><ul class="dropdown-menu dropdown-menu-end m-0"><li><a href="javascript:void(0)" data-id="'+email+'" class="dropdown-item partnerscall">Details</a></li><div class="dropdown-divider"></div><li><a href="javascript:void(0)" data-reference="'+email+'" class="dropdown-item text-danger delete-record">Delete</a></li></ul></div>';
                                },
                            },
                        ],
                        order: [[2, "desc"]],
                    ...
                    $("div.head-label").html(
                        '<h5 class="card-title mb-0">Details list for partnership</h5>',
                    )),
                101);
