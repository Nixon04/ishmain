        ...
        var l,
            ...
            r =
                (e.length &&
                    ((l = e.DataTable({
                        ajax:{
                            url: "/ishumanity/dashboard/release_allevents",
                            method: 'GET',
                            dataType: 'json',
                            dataSrc: 'data',
                          },
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                searchable: !1,
                                render: function (e, t, a, s) {
                                    var reference_uid = a.title;
                                    console.log(reference_uid);
                                    return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></a><ul class="dropdown-menu dropdown-menu-end m-0"><li><a href="javascript:;" class="dropdown-item">Details</a></li><div class="dropdown-divider"></div><li><a href="javascript:;" data-id="'+reference_uid+'" class="dropdown-item text-danger event-del delete-record" >Delete</a></li></ul></div><a href="#" class="btn btn-sm btn-icon item-edit" ><a href="'+ 'editblog/' +reference_uid +'" ><i class="bx bxs-edit"></i></a></a>';
                                },
                            },
                        ],
                        order: [[2, "desc"]],
                    ...
                    $("div.head-label").html(
                        '<h5 class="card-title mb-0">Events & Blogs</h5>',
                    )),
                101);
