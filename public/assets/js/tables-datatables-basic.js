            ...
            r =
                (e.length &&
                    ((l = e.DataTable({
                        ...
                        data: [
                            { id: 1, full_name: "John Doe", email: "john@example.com", start_date: "2022-01-01", salary: "50000", status: "Active" },
                            { id: 2, full_name: "Jane Smith", email: "jane@example.com", start_date: "2022-02-01", salary: "60000", status: "Inactive" },
                            { id: 3, full_name: "John Doe", email: "nixonsampson04@gmail.com", start_date: "2022-01-01", salary: "50000", status: "Active" },
                            { id: 4, full_name: "Jane Smith", email: "kingsley@gmail.com", start_date: "2022-02-01", salary: "60000", status: "Inactive" },
                            { id: 5, full_name: "John Doe", email: "ebukadickson@gmail.com", start_date: "2022-01-01", salary: "50000", status: "Active" },
                            { id: 6, full_name: "Jane Smith", email: "princewill@gmail.com", start_date: "2022-02-01", salary: "60000", status: "Inactive" },
                            { id: 7, full_name: "John Doe", email: "john@example.com", start_date: "2022-01-01", salary: "50000", status: "Active" },
                            { id: 8, full_name: "Jane Smith", email: "jane@example.com", start_date: "2022-02-01", salary:" 60000", status: "Inactive" },
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                searchable: !1,
                                render: function (e, t, a, s) {
                                    return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></a><ul class="dropdown-menu dropdown-menu-end m-0"><li><a href="javascript:;" class="dropdown-item">Details</a></li><div class="dropdown-divider"></div><li><a href="javascript:void(0)" class="dropdown-item text-danger delete-record">Delete</a></li></ul></div><a href="javascript:;" class="btn btn-sm btn-icon item-edit"><a href="javascript:void(0)"><i class="bx bxs-edit"></i></a></a>';
                                },
                            },
                        ],
                        order: [[2, "desc"]],
                        ...
                        buttons: [
                            ...
                            {
                                text: '<i class="bx bx-plus me-sm-1"></i>',
                    ...
                    $("div.head-label").html(
                        '<h5 class="card-title mb-0">GofundMe Users information</h5>',
                    )),
                101);
