...
>
  ...
  <body>
    ...
    @include('components.modal.partnerslist')
    @include('components.modal.delete_category')
    <script>
      var pdelete = "{{route('DeletePartnership')}}";
      var urlcall = "{{route('ReviewPartnership')}}";
      var csrf = "{{csrf_token()}}";
    </script>

     <script src="{{asset('assets/tables_data/partners.js')}}"></script>
     <script src="{{asset('assets/authentication/partnership_auth.js')}}"></script>
