...
>
  ...
  @include('components.modal.delete_category')
    ...
    <script>
      var alltransactions = "{{route('AllTransaction')}}";
      var urlcall = "{{route('EditEvents')}}";
      var deleteevents = "{{route('DeleteEvents')}}";
      var csrf = "{{csrf_token()}}";
    </script>

    <script src="{{asset('assets/authentication/editblog_post.js')}}"></script>
    <script src="{{asset('assets/components/modal_calls/blog_headers.js')}}"></script>
     <script src="{{asset('assets/authentication/events.js')}}"></script>
    ...
    <script src="{{asset('assets/tables_data/events.js')}}"></script>
