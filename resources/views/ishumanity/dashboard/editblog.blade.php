...
>
  ...
  @include('components.modal.toast')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
               ...
               <div class="post-box me-3">
                    <a href="{{route('EventsAndPlanning')}}" class="">
                        <li class="bx bx-chevrons-left"></li>
                    </a>
                  </div>
                  ...
                  <div class="card card-body-full">
                     ...
                     <div class="card-body card-body-full mb-4">
                      ...
                      <div class="layout-blog-main-post-container">
                          <button id="updatecall" class="btn btn-dashboard py-2">
                              update blog
                           </button>
                      </div>
    ...
    @include('components.modal.editblog_listing')

    @include('components.modal.delete_category')
    
    <script>
      var urlcall = "{{route('BlogEdit')}}";
      var csrf = "{{csrf_token()}}";
      var reference_log = "{{$reference_log}}";
    </script>
